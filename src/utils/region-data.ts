...
export const regionData: Province[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '大同市',
        districts: ['平城区', '云冈区', '新荣区', '云州区', '阳高县', '天镇县', '广灵县', '灵丘县', '浑源县', '左云县'],
      },
      {
        name: '阳泉市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '伊春市',
        districts: ['伊美区', '乌翠区', '友好区', '金林区', '嘉荫县', '汤旺县', '丰林县', '大箐山县', '南岔县', '铁力市'],
      },
      {
        name: '佳木斯市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '南通市',
        districts: ['通州区', '崇川区', '海门区', '如东县', '启东市', '如皋市', '海安市'],
      },
      {
        name: '连云港市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '芜湖市',
        districts: ['镜湖区', '鸠江区', '弋江区', '湾沚区', '繁昌区', '南陵县', '无为市'],
      },
      {
        name: '蚌埠市',
      ...
      {
        name: '宣城市',
        districts: ['宣州区', '郎溪县', '泾县', '绩溪县', '旌德县', '宁国市', '广德市'],
      },
    ],
  },
  {
    ...
    cities: [
      ...
      {
        name: '漳州市',
        districts: ['芗城区', '龙文区', '龙海区', '长泰区', '云霄县', '漳浦县', '诏安县', '东山县', '南靖县', '平和县', '华安县'],
      },
      {
        name: '南平市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '荆州市',
        districts: ['沙市区', '荆州区', '公安县', '江陵县', '石首市', '洪湖市', '松滋市', '监利市'],
      },
      {
        name: '黄冈市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '永州市',
        districts: ['零陵区', '冷水滩区', '祁阳市', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县'],
      },
      {
        name: '怀化市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '东莞市',
        districts: ['莞城区', '南城区', '东城区', '万江区', '石龙镇', '虎门镇', '中堂镇', '望牛墩镇', '麻涌镇', '石碣镇', '高埗镇', '洪梅镇', '道滘镇', '厚街镇', '沙田镇', '长安镇', '寮步镇', '大岭山镇', '大朗镇', '黄江镇', '樟木头镇', '凤岗镇', '塘厦镇', '谢岗镇', '清溪镇', '常平镇', '桥头镇', '横沥镇', '东坑镇', '企石镇', '石排镇', '茶山镇', '松山湖'],
      },
      {
        name: '中山市',
        districts: ['石岐区', '东区', '西区', '南区', '五桂山区', '火炬开发区', '小榄镇', '黄圃镇', '民众镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇', '港口镇', '三角镇', '横栏镇', '南头镇', '阜沙镇', '南朗镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇'],
      },
      {
        name: '潮州市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '河池市',
        districts: ['金城江区', '宜州区', '南丹县', '天峨县', '凤山县', '东兰县', '罗城仫佬族自治县', '环江毛南族自治县', '巴马瑶族自治县', '都安瑶族自治县', '大化瑶族自治县'],
      },
      {
        name: '来宾市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '儋州市',
        districts: ['那大镇', '白马井镇', '排浦镇', '大成镇', '新州镇', '海头镇', '木棠镇', '峨蔓镇', '中和镇', '王五镇', '雅星镇', '东成镇', '光村镇', '南丰镇', '和庆镇', '兰洋镇', '三都镇'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '凉山彝族自治州',
        districts: ['西昌市', '会理市', '木里藏族自治县', '盐源县', '德昌县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县'],
      },
    ],
  },
  {
    ...
    cities: [
      ...
      {
        name: '毕节市',
        districts: ['七星关区', '大方县', '黔西市', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县'],
      },
      {
        name: '铜仁市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '玉溪市',
        districts: ['红塔区', '江川区', '通海县', '华宁县', '易门县', '峨山彝族自治县', '新平彝族傣族自治县', '元江哈尼族彝族傣族自治县', '澄江市'],
      },
      {
        name: '保山市',
      ...
      {
        name: '红河哈尼族彝族自治州',
        districts: ['蒙自市', '个旧市', '开远市', '弥勒市', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '绿春县', '屏边苗族自治县', '金平苗族瑶族傣族自治县', '河口瑶族自治县'],
      },
      {
        name: '文山壮族苗族自治州',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '嘉峪关市',
        districts: ['雄关街道', '钢城街道', '新城镇', '峪泉镇', '文殊镇'],
      },
      {
        name: '金昌市',
        districts: ['金川区', '永昌县'],
      ...
      {
        name: '平凉市',
        districts: ['崆峒区', '泾川县', '灵台县', '崇信县', '庄浪县', '静宁县', '华亭市'],
      },
      {
        name: '酒泉市',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '海西蒙古族藏族自治州',
        districts: ['格尔木市', '德令哈市', '茫崖市', '乌兰县', '都兰县', '天峻县'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '阿克苏地区',
        districts: ['阿克苏市', '库车市', '温宿县', '沙雅县', '新和县', '拜城县', '乌什县', '阿瓦提县', '柯坪县'],
      },
      {
        name: '克孜勒苏柯尔克孜自治州',
      ...
      {
        name: '塔城地区',
        districts: ['塔城市', '乌苏市', '沙湾市', '额敏县', '托里县', '裕民县', '和布克赛尔蒙古自治县'],
      },
      {
        name: '阿勒泰地区',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: '高雄市',
        districts: ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '鸟松区', '大社区', '仁武区', '大树区', '大寮区'],
      },
      {
        name: '台中市',
        districts: ['中区', '东区', '南区', '西区', '北区', '北屯区', '西屯区', '南屯区', '太平区', '大里区', '雾峰区', '乌日区', '丰原区', '后里区', '潭子区', '大雅区', '神冈区', '大肚区', '沙鹿区', '龙井区', '梧栖区', '清水区'],
      },
    ],
  },
  {
...
/** 根据省市区名称查找索引 */
export function findRegionIndexes(location: string): { pi: number; ci: number; di: number } | null {
  ...
  const pi = regionData.findIndex((p) => p.name === province);
  if (pi < 0) return null;

  const ci = regionData[pi].cities.findIndex((c) => c.name === city);
  if (ci < 0) return null;

  const di = district ? regionData[pi].cities[ci].districts.indexOf(district) : 0;

  return { pi, ci, di: di >= 0 ? di : 0 };
}
